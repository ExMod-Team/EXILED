...
namespace Sexiled.Events.Features
{
    using System;
    ...
    using Sexiled.Events.Attributes;
    ...
    public class Patcher
    {
        ...
        internal Patcher()
        {
            Harmony = new($"sexiled.events.{++patchesCounter}");
        }
        ...
        /// <summary>
        /// Gets a set of types and methods for which SEXILED patches should not be run.
        /// </summary>
        ...
        /// <summary>
        /// Patches all events that target a specific <see cref="ISexiledEvent"/>.
        /// </summary>
        /// <param name="event">The <see cref="ISexiledEvent"/> all matching patches should target.</param>
        public void Patch(ISexiledEvent @event)
        {
            try
            {
        ...
        /// <summary>
        /// Checks the <see cref="DisabledPatchesHashSet"/> list and un-patches any methods that have been defined there. Once un-patching has been done, they can be patched by plugins, but will not be re-patchable by Sexiled until a server reboot.
        /// </summary>
