...
#pragma warning disable SA1623 // Property summary documentation should match accessors
    ...
    public class Player
    {
        ...
        /// <summary>
        /// Invoked after a <see cref="T:Sexiled.API.Features.Player" /> has an item added to their inventory.
        /// </summary>
        public static Event<ItemAddedEventArgs> ItemAdded { get; set; } = new();

        /// <summary>
        /// Invoked after a <see cref="T:Sexiled.API.Features.Player" /> has an item removed from their inventory.
        /// </summary>
        ...
        /// <summary>
        /// Called after a <see cref="T:Sexiled.API.Features.Player" /> has an item added to their inventory.
        /// </summary>
        ...
        /// <summary>
        /// Called after a <see cref="T:Sexiled.API.Features.Player" /> has an item removed from their inventory.
        /// </summary>
