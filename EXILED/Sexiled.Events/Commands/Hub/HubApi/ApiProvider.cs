...
namespace Sexiled.Events.Commands.Hub.HubApi
{
    using System;
    using System.IO;
    ...
    using Sexiled.Events.Commands.Hub.HubApi.Models;

    using Utf8Json;

    /// <summary>
    /// An API bridge to SEXILED Hub.
    /// </summary>
    public static class ApiProvider
    {
        ...
        /// <summary>
        /// Creates a HTTP client for SEXILED Hub API.
        /// </summary>
        ...
        internal static HttpClient CreateClient()
        {
            ...
            client.DefaultRequestHeaders.Add("User-Agent", $"Sexiled.Events (https://github.com/ExMod-Team/EXILED, {Assembly.GetExecutingAssembly().GetName().Version.ToString(3)})");
