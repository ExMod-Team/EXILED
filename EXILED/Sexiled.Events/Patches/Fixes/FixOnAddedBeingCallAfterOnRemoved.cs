...
namespace Sexiled.Events.Patches.Fixes
{
    ...
    internal class FixOnAddedBeingCallAfterOnRemoved
    {
        ...
        {
            Sexiled.API.Extensions.ReflectionExtensions.InvokeStaticEvent(typeof(InventoryExtensions), nameof(InventoryExtensions.OnItemAdded), new object[] { referenceHub, item, pickup });
            item.OnAdded(pickup);
        }
