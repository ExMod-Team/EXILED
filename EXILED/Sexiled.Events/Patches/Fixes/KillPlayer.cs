...
#pragma warning disable SA1313 // Parameter names should begin with lower-case letter
    ...
    internal class KillPlayer
    {
        ...
        {
            if (!DamageHandlers.IdsByTypeHash.ContainsKey(handler.GetType().FullName.GetStableHashCode()) && handler is GenericDamageHandler sexiledHandler)
                handler = sexiledHandler.Base;
        }
    }
}