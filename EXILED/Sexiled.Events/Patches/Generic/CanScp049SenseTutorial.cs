...
namespace Sexiled.Events.Patches.Generic
{
    ...
    internal static class CanScp049SenseTutorial
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            // if ((referenceHub.roleManager.CurrentRole.RoleTypeId == RoleTypeId.Tutorial && SexiledEvents.Instance.Config.CanScp049SenseTutorial) || Scp049Role.TurnedPlayers.Contains(Player.Get(referenceHub)))
            //     return;
            newInstructions.InsertRange(
                ...
                new[]
                {
                    ...
                    // if (!SexiledEvents.Instance.Config.CanScp049SenseTutorial)
