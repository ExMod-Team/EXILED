...
namespace Sexiled.Events.Patches.Generic
{
    ...
    using SexiledEvents = Sexiled.Events.Events;
    ...
    internal static class Scp079Scan
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            // if ((referenceHub.roleManager.CurrentRole.RoleTypeId == RoleTypeId.Tutorial && SexiledEvents.Instance.Config.TutorialNotAffectedByScp079Scan) || Scp079Role.TurnedPlayers.Contains(Player.Get(referenceHub)))
            //     return;
            newInstructions.InsertRange(
                ...
                new[]
                {
                    ...
                    // if (!SexiledEvents.Instance.Config.TutorialNotAffectedByScp079Scan)
                    new(OpCodes.Call, PropertyGetter(typeof(SexiledEvents), nameof(SexiledEvents.Instance))),
