...
namespace Sexiled.Events.Patches.Generic
{
    ...
    internal static class ParseVisionInformation
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            // if (referenceHub.roleManager.CurrentRole.RoleTypeId == RoleTypeId.Tutorial && !SexiledEvents.Instance.Config.CanTutorialTriggerScp096
            ...
            newInstructions.InsertRange(
                ...
                new[]
                {
                    ...
                    // !SexiledEvents.Instance.Config.CanTutorialTriggerScp096)
