...
namespace Sexiled.Events.Patches.Generic
{
    ...
    internal static class StayAtAmnesticCloud
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            // if (referenceHub.roleManager.CurrentRole.RoleTypeId == RoleTypeId.Tutorial && SexiledEvents.Instance.Config.TutorialAffectedByScp939AmnesticCloud
            ...
            newInstructions.InsertRange(
                ...
                new[]
                {
                    ...
                    // SexiledEvents.Instance.Config.TutorialAffectedByScp939AmnesticCloud)
