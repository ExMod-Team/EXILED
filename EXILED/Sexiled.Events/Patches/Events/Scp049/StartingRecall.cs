...
// </copyright>
// -----------------------------------------------------------------------
namespace Sexiled.Events.Patches.Events.Scp049
{
    ...
    using Sexiled.Events.EventArgs.Scp049;
    using HarmonyLib;
    ...
    internal static class StartingRecall
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            newInstructions.InsertRange(0, new CodeInstruction[]
            {
                ...
                new(OpCodes.Call, Method(typeof(Sexiled.API.Features.Player), nameof(Sexiled.API.Features.Player.Get), new[] { typeof(ReferenceHub) })),
