...
namespace Sexiled.Events.Patches.Events.Scp1344
{
    using Sexiled.API.Features.Items;
    using Sexiled.Events.Attributes;
    using Sexiled.Events.EventArgs.Scp1344;
    using HarmonyLib;
    ...
    internal static class Deactivating
    {
        private static bool Prefix(ref Scp1344Item __instance)
        {
            if (__instance._useTime == 0)
            {
                ...
                Sexiled.Events.Handlers.Scp1344.OnTryingDeactivating(ev);
            ...
            if (__instance._useTime + Time.deltaTime >= 5.1f)
            {
                ...
                Sexiled.Events.Handlers.Scp1344.OnDeactivating(deactivating);
                ...
                Sexiled.Events.Handlers.Scp1344.OnDeactivated(ev);
                return false;
            }
