...
namespace Sexiled.Events.Patches.Events.Warhead
{
    ...
    /// to add <see cref="Sexiled.API.Features.Warhead.DeadmanSwitchEnabled"/> and  <see cref="Warhead.DeadmanSwitchInitiating"/> events.
    /// </summary>
    ...
    internal static class DeadmanSwitchStart
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                // if (!Sexiled.API.Features.Warhead.DeadmanSwitchEnabled)
                //    return;
                new(OpCodes.Call, PropertyGetter(typeof(Sexiled.API.Features.Warhead), nameof(Sexiled.API.Features.Warhead.DeadmanSwitchEnabled))),
