...
namespace Sexiled.Events
{
    ...
    public sealed class Config : IConfig
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the name tracking (invisible SEXILED version string added to the end of the server name) is enabled or not.
        /// </summary>
        [Description("Indicates whether the name tracking (invisible SEXILED version string added to the end of the server name) is enabled or not")]
