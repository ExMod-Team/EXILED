...
namespace Sexiled.Events.EventArgs.Scp173
{
    ...
    public class BeingObservedEventArgs : IScp173Event, IDeniableEvent
    {
        ...
        /// </summary>
        /// <param name="target">
        /// The <see cref="Sexiled.API.Features.Player"/> instance of the target.
        /// </param>
        /// <param name="scp173">
        /// The <see cref="Sexiled.API.Features.Player"/> instance of the SCP-173.
        /// </param>
