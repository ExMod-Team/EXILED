...
namespace Exiled.Events.Patches.Events.Map
{
    ...
    internal static class FillingLocker
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            var offset = -3;
            var index = newInstructions.FindIndex(instruction => instruction.Calls(Method(typeof(HashSet<ItemPickupBase>), nameof(HashSet<ItemPickupBase>.Add), new[] { typeof(ItemPickupBase) }))) + offset;
