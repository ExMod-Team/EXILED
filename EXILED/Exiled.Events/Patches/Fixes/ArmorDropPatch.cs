...
namespace Exiled.Events.Patches.Fixes
{
    ...
    internal static class ArmorDropPatch
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            var continueIndex = newInstructions.FindIndex(x => x.Is(OpCodes.Call, Method(typeof(Dictionary<ushort, ItemBase>.Enumerator), nameof(Dictionary<ushort, ItemBase>.Enumerator.MoveNext)))) - 1;
            ...
            var index = newInstructions.FindIndex(x => x.Is(OpCodes.Ldc_I4_S, 9));
