...
namespace Exiled.Events.EventArgs.Player
{
    ...
    public class SearchingPickupEventArgs : IPlayerEvent, IPickupEvent, IDeniableEvent
    {
        ...
        /// </param>
        public SearchingPickupEventArgs(Player player, ItemPickupBase pickup, SearchSession searchSession, ISearchCompletor searchCompletor, float searchTime)
        {
            Player = player;
        ...
        /// </summary>
        public ISearchCompletor SearchCompletor { get; set; }
