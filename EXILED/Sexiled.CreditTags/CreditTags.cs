...
namespace Sexiled.CreditTags
{
    ...
    public sealed class CreditTags : Plugin<Config>
    {
        ...
        /// <inheritdoc/>
        public override string Prefix { get; } = "sexiled_credits";
        ...
        {
            [RankType.Dev] = new Rank("Sexiled Developer", "aqua", "00FFFF"),
            [RankType.Contributor] = new Rank("Sexiled Contributor", "magenta", "FF0090"),
            [RankType.PluginDev] = new Rank("Sexiled Plugin Developer", "crimson", "DC143C"),
            ...
            [RankType.Donator] = new Rank("SEXILED Supporter", "army_green", "4B5320"),
        };
