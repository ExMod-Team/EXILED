...
namespace Sexiled.CreditTags.Commands
{
    using System;
    ...
    /// <summary>
    /// A client command to show an SEXILED credit tag.
    /// </summary>
    [CommandHandler(typeof(ClientCommandHandler))]
    public class ShowCreditTag : ICommand
    {
        /// <inheritdoc/>
        public string Command { get; } = "sexiledtag";

        /// <inheritdoc/>
        public string[] Aliases { get; } = new[] { "crtag", "et", "ct" };

        /// <inheritdoc/>
        public string Description { get; } = "Shows your SEXILED Credits tag, if available.";
