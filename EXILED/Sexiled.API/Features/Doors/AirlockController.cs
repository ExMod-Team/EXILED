...
namespace Sexiled.API.Features.Doors
{
    ...
    public class AirlockController
    {
        ...
        /// </summary>
        internal static readonly Dictionary<BaseController, AirlockController> BaseToSexiledControllers = new(new ComponentsEqualityComparer());
        ...
        public AirlockController(BaseController controller)
        {
            ...
            BaseToSexiledControllers.Add(controller, this);
        }

        /// <summary>
        /// Gets the list with all airlocks.
        /// </summary>
        public static IReadOnlyCollection<AirlockController> List => BaseToSexiledControllers.Values;
        ...
        public static AirlockController Get(BaseController controller) => controller != null ? (BaseToSexiledControllers.TryGetValue(controller, out AirlockController airlockController) ? airlockController : new AirlockController(controller)) : null;
        ...
        /// <returns>Instance of <see cref="AirlockController"/>.</returns>
        public static AirlockController Get(Door door) => BaseToSexiledControllers.Values.FirstOrDefault(x => x.DoorA == door || x.DoorB == door);
