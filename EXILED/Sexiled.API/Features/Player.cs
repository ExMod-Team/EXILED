...
namespace Sexiled.API.Features
{
    ...
    using Enums;
    using Sexiled.API.Features.Core.Interfaces;
    using Sexiled.API.Features.CustomStats;
...
#pragma warning restore SA1401
        ...
        /// <summary>
        /// Converts NwPluginAPI player to SEXILED player.
        /// </summary>
        /// <param name="player">The NwPluginAPI player.</param>
        /// <returns>SEXILED player.</returns>
