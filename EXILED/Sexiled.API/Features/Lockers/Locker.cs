...
// </copyright>
// -----------------------------------------------------------------------
namespace Sexiled.API.Features.Lockers
{
    using System;
...
#nullable enable
    ...
    public class Locker : IWrapper<BaseLocker>, IWorldSpace
    {
        ...
        /// </summary>
        internal static readonly Dictionary<BaseLocker, Locker> BaseToSexiledLockers = new();
        ...
        {
            Base = locker;
            BaseToSexiledLockers.Add(locker, this);
        ...
        /// </summary>
        public static IReadOnlyCollection<Locker> List => BaseToSexiledLockers.Values;
        ...
        public static Locker? Get(BaseLocker locker) => locker == null ? null :
            BaseToSexiledLockers.TryGetValue(locker, out Locker supply) ? supply : new Locker(locker);
        ...
        /// <summary>
        /// Clears the cached lockers in the <see cref="BaseToSexiledLockers"/> dictionary.
        /// </summary>
        internal static void ClearCache()
        {
            BaseToSexiledLockers.Clear();
