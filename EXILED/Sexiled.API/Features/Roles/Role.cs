...
namespace Sexiled.API.Features.Roles
{
    ...
    using Enums;
    using Sexiled.API.Features.Core;
...
#pragma warning restore CS0618
            _ => throw new Exception($"Missing role found in Sexiled.API.Features.Roles.Role::Create ({role?.RoleTypeId}). Please contact an Sexiled developer."),
        };
    }
}
