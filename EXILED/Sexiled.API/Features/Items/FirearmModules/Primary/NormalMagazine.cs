...
namespace Sexiled.API.Features.Items.FirearmModules.Primary
{
    using System;
    ...
    public class NormalMagazine : PrimaryMagazine
    {
        ...
        /// <summary>
        /// Removes magazine from current <see cref="Sexiled.API.Features.Items.Firearm"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Inserts current magazine from current <see cref="Sexiled.API.Features.Items.Firearm"/>.
        /// </summary>
