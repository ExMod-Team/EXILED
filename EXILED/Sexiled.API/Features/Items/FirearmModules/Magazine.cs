...
namespace Sexiled.API.Features.Items.FirearmModules
{
    using System;

    using Sexiled.API.Features.Items.FirearmModules.Barrel;
    using Sexiled.API.Features.Items.FirearmModules.Primary;
    ...
    public abstract class Magazine
    {
        ...
        /// <summary>
        /// Gets target <see cref="Sexiled.API.Features.Items.Firearm"/> assotiated with this magazine.
        /// </summary>
