...
namespace Sexiled.Installer
{
    ...
    {
        /// <summary>
        /// The RootCommand to the Sexiled Installer
        /// </summary>
        public static readonly RootCommand RootCommand = new()
        {
            ...
            new Option<DirectoryInfo?>(
             ...
             new Option<DirectoryInfo?>(
                ...
                (parsed) =>
                {
                    ...
                    if (string.IsNullOrEmpty(appdataPath))
                        Console.Error.WriteLine("Your Sexiled path is null, make sure it exists");

                    string path = parsed.Tokens.SingleOrDefault()?.Value ?? appdataPath;

                    if (string.IsNullOrEmpty(path))
                    {
                        parsed.ErrorMessage = "--sexiled is null or empty, make sure your Sexiled folder exists";
                        return null;
                    }
                ...
                true,
                "Indicates the root path of Sexiled")
                { IsRequired = true },
            ...
            new Option<string?>(
                "--target-port",
                "Target port for SexiledLoader installation")
                { IsRequired = false },
...
#nullable disable
        ...
        /// <summary>
        /// Gets or sets the Sexiled directory path.
        /// </summary>
        public DirectoryInfo Sexiled { get; set; }
#nullable restore
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the version of Sexiled available.
        /// </summary>
