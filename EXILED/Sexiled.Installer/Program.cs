...
namespace Sexiled.Installer
{
    ...
    using Sexiled.Installer.Properties;
    ...
    internal enum PathResolution
    {
        ...
        /// <summary>
        /// Sexiled path that is routed to sexiled root path.
        /// </summary>
        Sexiled,
    }
    ...
    internal static class Program
    {
        ...
        private const string SexiledAssetName = "sexiled.tar.gz";
        ...
        internal static async Task MainSafe(CommandSettings args)
        {
            ...
            try
            {
                ...
                Console.WriteLine(Resources.Program_MainSafe_Sexiled_folder___0_, args.Sexiled.FullName);
                ...
                ReleaseAsset? sexiledAsset = targetRelease!.Assets.FirstOrDefault(a => a.Name.Equals(SexiledAssetName, StringComparison.OrdinalIgnoreCase));
                if (sexiledAsset is null)
                {
                ...
                Console.WriteLine(FormatAsset(sexiledAsset));
                ...
                using HttpResponseMessage downloadResult = await httpClient.GetAsync(sexiledAsset.BrowserDownloadUrl).ConfigureAwait(false);
            ...
            else
            {
                ...
                switch (ResolveEntry(entry))
                {
                    case PathResolution.Absolute:
                        ...
                        break;
                    case PathResolution.Sexiled:
                        ResolvePath(entry.Name, args.Sexiled.FullName, out path);
                        ExtractEntry(tarInputStream, entry, path);
                        break;
                    default:
