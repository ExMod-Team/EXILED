...
namespace Sexiled.Example.Events
{
    ...
    using Sexiled.Events.EventArgs.Scp106;
    using Sexiled.Events.EventArgs.Scp914;
    ...
    {
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnDied(DiedEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnChangingRole(ChangingRoleEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnChangingItem(ChangingItemEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Scp106.OnTeleporting(TeleportingEventArgs)"/>
        public void OnTeleporting(TeleportingEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} is teleporting to {ev.Position} as SCP-106!");
        }

        /// <inheritdoc cref="Sexiled.Events.Handlers.Scp914.OnActivating(ActivatingEventArgs)"/>
        public void OnActivating(ActivatingEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} is activating SCP-914!");
        }

        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnFailingEscapePocketDimension(FailingEscapePocketDimensionEventArgs)"/>
        public void OnFailingEscapePocketDimension(FailingEscapePocketDimensionEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} is failing to escape from the pocket dimension!");
        }

        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnEscapingPocketDimension(EscapingPocketDimensionEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Scp914.OnChangingKnobSetting(ChangingKnobSettingEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.Joined"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.UnlockingGenerator"/>
        public void OnUnlockingGenerator(UnlockingGeneratorEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} is trying to unlock a generator in {ev.Player.CurrentRoom} room");
        }

        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.Destroying"/>
        public void OnDestroying(DestroyingEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} ({ev.Player.Role}) is leaving the server!");
        }

        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.Dying"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.PreAuthenticating"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnPickingUpItem(PickingUpItemEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnUsingItem(UsingItemEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnShooting(ShootingEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnReloadingWeapon(ReloadingWeaponEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnReceivingEffect(ReceivingEffectEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Scp914.OnUpgradingPlayer(UpgradingPlayerEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnDroppingItem(DroppingItemEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnSpawned(SpawnedEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.OnEscaping(EscapingEventArgs)"/>
        ...
        /// <inheritdoc cref="Sexiled.Events.Handlers.Player.Hurting"/>
