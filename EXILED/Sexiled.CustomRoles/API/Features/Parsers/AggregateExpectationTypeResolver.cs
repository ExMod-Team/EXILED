...
namespace Sexiled.CustomRoles.API.Features.Parsers
{
    ...
    using Sexiled.CustomRoles.API.Features.Extensions;
        ...
        where T : class
    {
        ...
        public AggregateExpectationTypeResolver(INamingConvention namingConvention)
        {
            ...
            foreach (Assembly assembly in AppDomain.CurrentDomain.GetAssemblies())
            {
                ...
                {
                    Log.Error($"Error loading types for {assembly.FullName}. It can be ignored if it's not using Sexiled.CustomRoles.");
                    Log.Debug(e);
                }
            }
        }
