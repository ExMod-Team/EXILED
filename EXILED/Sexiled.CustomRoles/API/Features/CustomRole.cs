...
namespace Sexiled.CustomRoles.API.Features
{
    using System;
    ...
    public abstract class CustomRole
    {
        ...
        protected virtual void SubscribeEvents()
        {
            ...
            Sexiled.Events.Handlers.Player.ChangingNickname += OnInternalChangingNickname;
            Sexiled.Events.Handlers.Player.ChangingRole += OnInternalChangingRole;
            Sexiled.Events.Handlers.Player.Spawned += OnInternalSpawned;
            Sexiled.Events.Handlers.Player.SpawningRagdoll += OnSpawningRagdoll;
            Sexiled.Events.Handlers.Player.Destroying += OnDestroying;
        }
