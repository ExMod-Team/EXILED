...
namespace Sexiled.CustomRoles.API.Features
{
    ...
    using Sexiled.CustomRoles.API.Features.Enums;
    using Sexiled.Events.EventArgs.Player;
    using Sexiled.Events.EventArgs.Server;
    ...
    internal class KeypressActivator
    {
        ...
        {
            Sexiled.Events.Handlers.Player.TogglingNoClip += OnTogglingNoClip;
            Sexiled.Events.Handlers.Server.EndingRound += OnEndingRound;
        }
