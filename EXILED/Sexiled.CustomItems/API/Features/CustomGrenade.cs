...
namespace Sexiled.CustomItems.API.Features
{
    ...
    using Sexiled.API.Features.Pickups.Projectiles;
    ...
    public abstract class CustomGrenade : CustomItem
    {
        ...
        {
            Sexiled.Events.Handlers.Player.ThrowingRequest += OnInternalThrowingRequest;
            Sexiled.Events.Handlers.Player.ThrownProjectile += OnInternalThrownProjectile;
            Sexiled.Events.Handlers.Map.ExplodingGrenade += OnInternalExplodingGrenade;
            Sexiled.Events.Handlers.Map.ChangedIntoGrenade += OnInternalChangedIntoGrenade;
        ...
        private void OnInternalThrownProjectile(ThrownProjectileEventArgs ev)
        {
            ...
            if (ExplodeOnCollision)
                ev.Projectile.GameObject.AddComponent<Sexiled.API.Features.Components.CollisionHandler>().Init((ev.Player ?? Server.Host).GameObject, ev.Projectile.Base);
        }
        ...
        private void OnInternalChangedIntoGrenade(ChangedIntoGrenadeEventArgs ev)
        {
            ...
            if (ExplodeOnCollision)
                ev.Projectile.GameObject.AddComponent<Sexiled.API.Features.Components.CollisionHandler>().Init((ev.Pickup.PreviousOwner ?? Server.Host).GameObject, ev.Projectile.Base);
        }
    }
}
