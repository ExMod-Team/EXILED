...
namespace Sexiled.CustomItems.API.Features
{
    ...
    public abstract class CustomWeapon : CustomItem
    {
        ...
        {
            Sexiled.Events.Handlers.Player.ReloadingWeapon += OnInternalReloading;
            Sexiled.Events.Handlers.Player.ReloadedWeapon += OnInternalReloaded;
            Sexiled.Events.Handlers.Player.Shooting += OnInternalShooting;
            Sexiled.Events.Handlers.Player.Shot += OnInternalShot;
            Sexiled.Events.Handlers.Player.Hurting += OnInternalHurting;
