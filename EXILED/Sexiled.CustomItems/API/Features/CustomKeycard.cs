...
namespace Sexiled.CustomItems.API.Features
{
    ...
    using Sexiled.API.Features.Lockers;
    ...
    public abstract class CustomKeycard : CustomItem
    {
        ...
        protected override void SubscribeEvents()
        {
            ...
            Sexiled.Events.Handlers.Player.InteractingDoor += OnInternalInteractingDoor;
            Sexiled.Events.Handlers.Player.InteractingLocker += OnInternalInteractingLocker;
            Sexiled.Events.Handlers.Item.KeycardInteracting += OnInternalKeycardInteracting;
        }
